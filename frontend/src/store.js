...
import {itemBrandListReducer,itemOurProductReducer, //self coded
  itemCategoryListReducer,itemCreateReducer,itemRemoveReducer,itemInfoReducer,itemListReducer,itemReviewNewReducer,itemAmendReducer,} from './reducers/itemReducers';
import {customerRemoveReducer,customerInfoReducer,customerHistoryReducer,customerRegisterReducer,customerLoginReducer,customerAmendAccountReducer,customerAmendReducer,} from './reducers/customerReducers';
...
userRegister: customerRegisterReducer,newCustomerPurchase: purchaseNewReducer,purchaseDetails: purchaseInfoReducer,purchasePayment: purchasePayPalReducer,displayPurchaseAccount: purchaseAccountHistoryReducer,userInfo: customerInfoReducer,userAmendAccount: customerAmendAccountReducer,userAmend: customerAmendReducer,itemNew: itemCreateReducer,itemAmend: itemAmendReducer,itemRemove: itemRemoveReducer,displayPurchase: purchaseHistoryReducer,purchaseRemove: purchaseRemoveReducer,purchaseShipping: purchaseShippingReducer,userList: customerHistoryReducer,userDelete: customerRemoveReducer,displayCategories:itemCategoryListReducer,
